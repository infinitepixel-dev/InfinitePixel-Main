...
const deviceConfig = [
  // SECTION - Mobile Devices BEGIN

  //NOTE m384 - Galaxy S23 Ultra
  {
    type: "m320",
    query: "(min-width: 320px) and (max-width: 740px)" /* Opera GX Mobile */,
    layout: {
      heroPage: {
  ...
  //!SECTION - Mobile Devices END
  //SECTION - Tablet Devices
  // Tablet
  {
    type: "t768",
    query: "(min-width: 768px) and (max-width: 912px)",
    layout: {
      heroPage: {
        heroPageContainer: "relative overflow-hidden h-dvh overscroll-none",
  ...
  //!SECTION - Tablet Devices END
  //SECTION - Laptop Devices
  //TODO Laptops

  //!SECTION - Laptop Devices END
  //SECTION - Desktop Devices
  //NOTE d1080p
  {
    type: "d1080p", // 1080p Desktop
    // query:
    //   "(min-width: 1889px) and (max-width: 1920px) and (max-height: 1080px)",
    query: "(min-width: 1889px) and (max-width: 1920px)",
    layout: {
      heroPage: {
        heroPageContainer: "relative overflow-hidden h-dvh overscroll-none",
  ...
  //NOTE d1400p
  {
    type: "d1400p", // 1400p Desktop
    query: "(min-width: 1400px) and (max-width: 1400px)",
    layout: {
      paymentsPage: {
        paymentCardContainer: () => {
          return (
      ...
      heroPage: {
        ...
        heroTitle: () => {
          return (
            <>
              <div className="self-center col-span-6 col-start-2 font-medium leading-tight tracking-normal text-center text-4xl">
                Developing Responsive Websites
              </div>
              <div className="self-center col-span-4 col-start-3 row-start-2 font-medium text-center text-8xl">
                For Your Brand
  ...
  //NOTE d1440p
  {
    ...
    // query: "(min-width: 2560px) and (max-height: 1440px)",
    query: "(min-width: 2519px) and (max-width: 2560px) ",
    layout: {
      paymentsPage: {
        paymentCardContainer: () => {
          return (
  ...
  //NOTE d2560p
  {
    ...
    query: "(min-width: 3779px) and (max-width: 3840px)",
    layout: {
      heroPage: {
        heroPageContainer: "relative overflow-hidden h-dvh overscroll-none",
  ...
  //!SECTION - Desktop Devices END
  // Add other device configurations here, similar to the one above.

  //ANCHOR Unsupported Devices
  {
    type: "404 unsupported",

    query: "",
    //layout should show 404
    layout: {
      ...
      heroPage: {
        heroPageContainer: "relative overflow-hidden h-dvh overscroll-none",
        heroPageElement:
          "grid w-full h-screen grid-cols-8 overflow-hidden grid-rows-8 overscroll-contain",
        heroTitle: () => {
          return (
            <>
              <div className="row-start-4 col-start-4 text-center col-span-2 text-4xl">
