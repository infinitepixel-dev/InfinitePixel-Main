...
const AboutUs = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="flex flex-col items-center justify-between p-8 bg-gray-100 md:flex-row"
    >
      ...
      <div ref={textRef} className="w-full text-left md:w-1/2 md:pl-8">
        ...
        <p className="mb-4 text-lg text-gray-700">
          ...
          to your business needs. With a focus on responsive design, user
          experience, and modern technologies, our team ensures that every
          project meets the highest standards. We take pride in our transparent
          process, working closely with clients from conception to launch.
          Choose Infinite Pixel, and let us bring your vision to life with a
          website that’s not just beautiful but also functional and secure.
        </p>
