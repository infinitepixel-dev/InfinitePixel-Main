...
export function PricingCard() {
  ...
  const default_Card3Container =
    "grid grid-cols-8 grid-rows-4 col-span-1 col-start- row-start-4 p-4 rounded-lg shadow-lg bg-slate-100"
            ...
            `}
              >
                <svg
                  ...
                  viewBox="0 -50 555 350"
                  className="relative w-full col-start-1 row-start-1 m-0 col-span-full"
