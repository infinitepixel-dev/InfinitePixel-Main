  ...
  return (
    <div className="relative overflow-hidden overscroll-none">
      ...
      <div className="z-10 grid w-full grid-cols-8 gap-1 overflow-hidden h-dvh grid-rows-8 md:grid-cols-8 lg:grid-rows-5 lg:grid-cols-12 xl:grid-rows-8 xl:grid-cols-12 column">
        ...
        <div className="mt-10 text-2xl galaxyS23Ultra:text-base xs:row-start-3 xs:text-1xl xs:col-start-2 xs:col-span-6 md:col-span-4 md:col-start-2 md:row-start-4">
        ...
        <button className="self-center col-span-6 p-5 text-4xl leading-none tracking-tight text-center duration-700 rounded-lg galaxyS23Ultra:row-start-6 xs:mt-36 xs:col-start-2 xs:row-start-7 xl:col-span-3 xl:col-start-2 xl:row-start-7 xl:m-2 drop-shadow-xl text-slate-100 bg-violet-700 md:text-2x1 hover:bg-violet-800">
          Start Your Project
        </button>
      </div>
    </div>
