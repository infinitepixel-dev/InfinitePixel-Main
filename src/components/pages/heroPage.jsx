  ...
  return (
    <div className="relative overflow-hidden">
      ...
      >
        ...
        <div className="col-span-6 col-start-2 col-end-4 row-start-1 row-end-4 mt-10 lg:row-start-1">
          <div className="font-bold leading-normal tracking-normal md:text-7xl xl:text-8x1">
            Developing Responsive Websites
            <span className=""> For Your Brand</span>
          </div>
          <button
            className="mt-10 text-5xl leading-normal tracking-tight text-center duration-700 text-slate-150 bg-violet-600 md:text-2x1 hover:bg-violet-700"
            style={{
              position: "relative",
              width: "350px",
              height: "89px",
        ...
        <div className="grid grid-cols-1 mt-10 lg:col-span-8 lg:col-start-2 lg:col-end-12 lg:row-start-5 lg:gap-6 lg:row-span-2 lg:grid-cols-4 xl:row-start-6 xl:grid-cols-8">
          {/* Web Design */}
          <div className="lg:row-span-2 pe-4 lg:col-span-2">
            <hr className="w-full border-t-2 border-gray-300" />

            <div className="mt-2 font-bold leading-normal tracking-normal md:text-3xl">
              Web Design
            </div>
          ...
          {/* Data Transfer */}
          <div className="col-span-2 row-span-2 pe-4">
            <hr className="w-full border-t-2 border-gray-300" />

            <div className="mt-2 text-2xl font-bold leading-normal tracking-normal md:text-3xl">
              Data Transfer
            </div>
            <div className="mt-2 text-xl leading-7">
