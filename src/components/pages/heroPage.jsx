    ...
    <div className="relative overflow-hidden overscroll-none">
      ...
      >
        ...
        <a
          ...
          className="self-center col-start-2 col-end-8 row-start-4 text-4xl leading-normal tracking-tight text-center duration-700 rounded-lg xxl:row-start-5 xxl:p-4 xxl:col-span-2 xxl:col-start-2 xl:mb-20 xs:col-span-5 xl:p-2 xs:row-start-3 xs:mt-12 lg:row-start-3 xl:row-start-6 xl: xl:col-start-2 xl:col-span-3 text-slate-150 bg-violet-600 md:text-2x1 hover:bg-violet-700"
        >
          Get Started
        </a>
