...
const AboutUs = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="flex md:flex-row flex-col justify-between items-center bg-bg-slate-50 mt-12 p-2"
    >
      ...
      <div ref={textRef} className="md:pl-8 w-full md:w-1/2 text-left">
        <h2 className="mt-4 mb-4 font-semibold text-cyan-950 text-3xl text-center">
