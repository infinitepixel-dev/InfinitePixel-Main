...
const Footer = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-gradient-to-t from-zinc-900 to-zinc-950 px-4 py-8 w-full text-white"
    >
      <div className="flex flex-col items-center space-y-4">
        <p className="font-semibold text-sm text-center tracking-wide">
          &copy; {currentYear} Infinite Pixel Web Design
        </p>

        <p className="text-gray-200 text-sm">Find us on socials</p>
