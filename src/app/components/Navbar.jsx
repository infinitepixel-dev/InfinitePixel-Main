...
const Navbar = () => {
  ...
  return (
    <nav
      className={`top-0 left-0 z-50 w-full fixed ${
      ...
      <div className="relative flex items-center justify-between w-full p-4 transition-colors duration-300 bg-transparent">
        ...
        <div className="flex items-center ml-auto">
          <button
            ...
            onClick={() => {
              //On Click, route to home and then output #contact-form to scroll to the bottom on the homepage.
        ...
        <div className="relative flex flex-col items-center space-y-10 text-6xl transition-transform transform text-slate-100">
          ...
          {menuItems.map((item, index) => (
            <button
              ...
              role="menuitem"
              tabIndex={-1} // Ensures arrow-key navigation within menu works properly if added
              onClick={() => {
